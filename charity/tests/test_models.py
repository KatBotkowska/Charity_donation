...
class CategoryModelTest(TestCase):
    ...
    def test_get_object(self):
        ...
        #self.assertEquals(Category.objects.get(name='test_category').name, self.category().name)
        self.assertEquals(Category.objects.get(name='test_category').name, self.setUpTestData().name)
...
class IstitutionModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        Institution.objects.create(name='test_institution', description='institution for test purpose', categories=test_category )